...
const BAG2 = [
  ...
  { id:'b2_16', num:'١٦', title:'كتاب تفاعلي النظافة الشخصية', img:'activities/b2_16.jpg', desc:'التعرف على أدوات النظافة الشخصية وربطها بأعضاء الجسم', duration:'٢٠ دقيقة', place:'غرفة المصادر أو قاعة النشاط', strategy:'الربط المنطقي، المحاكاة (النمذجة)', goals:['يتعرف على أدوات النظافة الشخصية (فرشاة، صابون، منشفة، مشط) ويذكر وظيفة كل منها','يربط بين الأداة وعضو الجسم المناسب لها (مثلاً: الفرشاة للأسنان)','يظهر وعياً بأهمية النظافة الشخصية للعناية بجسمه وصحته'], tools:'صندوق المفاجآت: صندوق مزين يحتوي على أدوات نظافة حقيقية أو مجسمات بلاستيكية. لوحة جسمي النظيف: لوحة كرتونية مرسوم عليها وجه ويدين وشعر. بطاقات مصورة: صور للأدوات وصور مقابلة للأفعال', steps:['التمهيد: ابدئي بعرض مشهد تمثيلي قصير بدمية يد تشعر بالاتساخ، أو أنشودة بسيطة (هيا نغسل وجهنا.. هيا نغسل يدنا). اسألي الأطفال: كيف نجعل صديقتنا الدمية نظيفة وجميلة؟ ثم استخرجي الأدوات من الصندوق واحدة تلو الأخرى وسميها معهم','التنفيذ: اعرضي لوحة جسمي النظيف أمام الأطفال. أمسكي المشط وقولي: شعري يحتاج لترتيب، أي أداة تساعدني؟ ثم ضعي المشط بجانب صورة الشعر على اللوحة. اطلبي من الطفل استخراج أداة من صندوق المفاجآت ووصف شكلها أو لونها. دعي الطفل يحاول تحديد العضو المسؤول عن استخدام هذه الأداة على اللوحة. شجعي الطفل على محاكاة الحركة (تمثيل حركة غسل اليدين أو تفريش الأسنان)','التقييم: ما هي الأداة التي نستخدمها لكي نجعل أسناننا بيضاء وقوية؟'], eval:'ما هي الأداة التي نستخدمها لكي نجعل أسناننا بيضاء وقوية؟' }
];
